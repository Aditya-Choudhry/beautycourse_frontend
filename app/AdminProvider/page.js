...
export default function AdminProvider() {
    const data = [
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Paid" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Pending" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Unpaid" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Pending" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Paid" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Unpaid" },
        { id: "00212", name: "Nick Jones", email: "darrensammy@gmail.com", status: "Paid" },
      ...
      <div className="fixed left-0 top-0 w-64 h-full bg-white shadow-md z-10">
        ...
        <div className="mt-12">
          ...
          <nav>
            ...
            <a href="/AdminProvider" className="flex items-center  px-6 py-3 text-[#658396] hover:bg-gray-100">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div className="overflow-x-auto p-4">
      <table className="w-full border-collapse shadow-lg">
        ...
        <tbody>
          {data.map((row, index) => (
            <tr key={index} className="bg-blue-200 text-[#5A5A5A]">
              <td className="p-3">{row.id}</td>
              <td className="p-3 font-semibold">{row.name}</td>
              <td className="p-3 ">{row.email}</td>
              <td className={`p-3 font-semibold ${statusColors[row.status]}`}>{row.status}</td>
              <td className="p-3">
