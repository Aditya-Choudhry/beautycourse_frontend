      ...
      <div className="fixed left-0 top-0 w-64 h-full bg-white shadow-md z-10">
        ...
        <div className="mt-12">
          ...
          <nav>
            ...
            <a href="/UserProfile" className="flex items-center text-[#658396] px-6 py-3 hover:bg-gray-100">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className=" rounded-lg p-8 ">
            <form>
              ...
              <div className="mb-6">
                ...
                <input 
                  type="text" 
                  placeholder="(microblading, lashes, facials, etc.)" 
                  className="w-full border-b-2 border-gray-300 py-2 focus:outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div className="flex justify-end">
                <button 
                  type="submit" 
                  className="bg-[#658396] gap-4 inline-flex text-white px-6 py-2 rounded-full  items-center"
                >
                  Save   <Image
                      src="/Send.png"
                      alt="Beauty Training"
