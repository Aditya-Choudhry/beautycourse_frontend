...
export default function UserLeads() {
  ...
  return (
    <div className="flex flex-1 justify-center items-center min-h-screen ml-64 mr-64">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-xl max-w-md w-full">
        <h2 className="text-2xl font-serif text-center text-gray-900 mb-4">Lead</h2>
        <form className="space-y-4">
          <input
            type="text"
            placeholder="Maria Alex"
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-3 rounded-md text-lg font-medium hover:bg-blue-600 transition"
          >
            Send Email
          </button>
        </form>
